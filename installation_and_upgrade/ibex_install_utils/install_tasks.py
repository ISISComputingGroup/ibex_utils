...
INSTRUMENTS_WITH_LABVIEW_VI = ["TE:NDW2455:"]
...
class UpgradeInstrument:
    ...
    def run_instrument_deploy_pre_stop(self):
        ...
        """
        self._system_tasks.user_confirm_upgrade_type_on_machine('Client/Server Machine')
        # central_inst_info = g.get_pv("CS:INSTLIST:CENTRAL:INFO").get()
        central_inst_info = g.get_pv("TE:NDW2455:CS:INSTLIST")
        central_inst_info =  dehex_and_decompress(bytes(central_inst_info, encoding="utf8")).decode("utf-8")
        ...
        # INSTRUMENTS_WITH_LABVIEW_VI could be a list generated by looking at a text file on network/github
